...
- Distribution of prices across different areas
- Correlations between features like size, location, and price
...
- Effect of size, rooms, and location on price
...
| Sklearn | Preprocessing and encoding |
...
- Several outliers found in luxury price range
